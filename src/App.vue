<template>
  <nav id="site-navigation" role="navigation" class="row row-center">
	<div class="column">
		<h1>
			<a href="index.php">Hama Beads</a>
		</h1>
		<ul class="main-menu column clearfix">
			<li><a href="aboutView.vue">Blog</a></li>
...
nav#site-navigation h1 {
	background: #fff url('header-background.jpg') no-repeat left bottom;
